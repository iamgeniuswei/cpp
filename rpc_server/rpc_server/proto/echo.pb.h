...
inline ::google::protobuf::int32 EchoRequest::id() const {
  // @@protoc_insertion_point(field_get:echo.EchoRequest.id)
  return id_;
}
inline void EchoRequest::set_id(::google::protobuf::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  id_ = value;
...
// required int32 id = 1;
inline bool EchoResponse::has_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
...
inline ::google::protobuf::int32 EchoResponse::id() const {
  // @@protoc_insertion_point(field_get:echo.EchoResponse.id)
  return id_;
}
inline void EchoResponse::set_id(::google::protobuf::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  id_ = value;
  // @@protoc_insertion_point(field_set:echo.EchoResponse.id)
}
